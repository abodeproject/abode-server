...
RoomSchema.methods.motion_on =  getStatuses( {'type': 'motion_sensors', 'key': '_motion', 'filter': true} );
RoomSchema.methods.motion_off = getStatuses( {'type': 'motion_sensors', 'key': '_motion', 'filter': false} );
