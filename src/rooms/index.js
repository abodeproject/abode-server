...
RoomSchema.methods.motion_on =  getStatuses( {'type': 'motion_sensors', 'key': 'motion_on', 'filter': true} );
RoomSchema.methods.motion_off = getStatuses( {'type': 'motion_sensors', 'key': 'motion_off', 'filter': true} );
